...
## V2 SkillGuard 与 Policy CLI

Rust V2 核心通过现有 `skill-ledger` 命令提供 **SkillGuard**：本地扫描、系统密钥签名、版本历史、
...
[V2 核心指南](../../docs/user-guide/zh/agent-security/agent-sec-core/skillguard-v2.md)。
