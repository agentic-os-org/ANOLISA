# AgentSecCore V2 Policy, SkillGuard and daemon

SkillGuard supplies scanning, system-key integrity, versions and activation through the Rust
`skill-ledger` CLI and a root daemon. See the [core guide](../../../docs/user-guide/en/agent-security/agent-sec-core/skillguard-v2.md)
and [migration/acceptance boundaries](../docs/design/SKILL_GUARD_PHASE_ONE.md).
