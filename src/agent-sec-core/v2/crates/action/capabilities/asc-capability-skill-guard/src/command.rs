//! Closed `SkillGuard` operation contract; physical roots and caller identity are injected separately.

use crate::{DecisionAction, GuardError, SkillIdentity};
...
impl GuardCommand {
    ...
    pub fn identities(&self, managed: &[SkillIdentity]) -> Result<Vec<SkillIdentity>, GuardError> {
