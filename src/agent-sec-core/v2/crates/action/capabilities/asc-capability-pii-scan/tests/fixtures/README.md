...
inputs and byte limits. Comparisons ignore elapsed time and additive V2 evidence
metadata. Custom rule behavior is validated separately using isolated rule sets.
