...
pub const ACTION_SKILL_GUARD: &str = "action.skill_guard";
...
pub const ACTION_METHODS: [&str; 2] = [ACTION_CODE_SCAN, ACTION_SKILL_GUARD];
...
pub fn resolve(method: &str) -> Option<MethodId> {
    match method {
        ...
        ACTION_SKILL_GUARD => Some(MethodId::Action(ActionMethod::SkillGuard)),
        _ => None,
    }
}
