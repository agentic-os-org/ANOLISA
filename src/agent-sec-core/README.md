...
## V2 SkillGuard and Policy CLI

The Rust V2 core adds **SkillGuard** behind the existing `skill-ledger` command: local scanners,
...
See the [V2 core guide](../../docs/user-guide/en/agent-security/agent-sec-core/skillguard-v2.md)
