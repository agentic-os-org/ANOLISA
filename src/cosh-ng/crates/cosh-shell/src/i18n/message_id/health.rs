macro_rules! health_ids {
    ($next:ident, $remaining:tt, $($ids:ident,)*) => {
        $next!(
            ...
            HealthLiveSectionTitle,
            HealthLiveCoreAlive,
            HealthLiveCoreNoResponse,
            HealthLiveCoreNoRuntime,
            HealthLiveRecovery,
            HealthLiveRoutingFacts,
            HealthLiveCnfHandler,
            HealthLiveLastRoute,
            HealthLiveRoutingHint,
            HealthFindingRouteFallback,
            HealthFindingCoreNoResponse,
            HealthFindingRecoveryFailed,
            HealthRemediationRouteFallback,
            HealthRemediationCoreNoResponse,
            HealthLiveReasonAiDisabled,
            HealthLiveReasonAssistanceOff,
